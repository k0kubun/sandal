...
func TestParseStatement(t *testing.T) {
	...
	parseInBlock(t, "recv(ch, 1, 2);", RecvStatement{Pos{1, 1 + parseBlockOffset}, IdentifierExpression{Pos{1, 6 + parseBlockOffset}, "ch"}, []Expression{NumberExpression{Pos{1, 10 + parseBlockOffset}, "1"}, NumberExpression{Pos{1, 13 + parseBlockOffset}, "2"}}, nil})
	parseInBlock(t, "recv(ch, 1, 2) @omission;", RecvStatement{Pos{1, 1 + parseBlockOffset}, IdentifierExpression{Pos{1, 6 + parseBlockOffset}, "ch"}, []Expression{NumberExpression{Pos{1, 10 + parseBlockOffset}, "1"}, NumberExpression{Pos{1, 13 + parseBlockOffset}, "2"}}, []string{"omission"}})
	...
	parseInBlock(t, "send(ch, 1, 2);", SendStatement{Pos{1, 1 + parseBlockOffset}, IdentifierExpression{Pos{1, 6 + parseBlockOffset}, "ch"}, []Expression{NumberExpression{Pos{1, 10 + parseBlockOffset}, "1"}, NumberExpression{Pos{1, 13 + parseBlockOffset}, "2"}}, nil})
	parseInBlock(t, "send(ch, 1, 2) @commission;", SendStatement{Pos{1, 1 + parseBlockOffset}, IdentifierExpression{Pos{1, 6 + parseBlockOffset}, "ch"}, []Expression{NumberExpression{Pos{1, 10 + parseBlockOffset}, "1"}, NumberExpression{Pos{1, 13 + parseBlockOffset}, "2"}}, []string{"commission"}})
